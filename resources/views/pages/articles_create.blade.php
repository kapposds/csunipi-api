        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading"><b>Νέο Άρθρο</b></div>
                    <div class="panel-body">
                        <div class="form-horizontal">

                            <form class="form-horizontal" method="POST" action="/articles" enctype="multipart/form-data" role="form">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" id="article_title" name="title" value="{{ old('title') }}">
                                ...
                                <div class="form-group {{ $errors->has('alias') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" id="article_alias" name="alias" value="{{ old('alias') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-5 {{ $errors->has('category_with_articles') ? ' has-error' : '' }}">
                                            ...
                                            <select id="category_with_articles" name="category_with_articles" >
                                                ...
                                                @foreach ($pages_with_articles as $page)
                                                    ...
                                                    <option value="{{$page->alias}}" @if (old('category_with_articles') == $page->alias) selected="selected" @endif >{{$page->viewtitle}}</option>
                                        ...
                                        <div class="col-md-5 {{ $errors->has('category_without_articles') ? ' has-error' : '' }}">
                                            ...
                                            <select id="category_without_articles" name="category_without_articles" >
                                                ...
                                                <option value="{{$page->alias}}" @if (old('category_without_articles') == $page->alias) selected="selected" @endif >{{$page->viewtitle}}</option>
                                ...
                                <div class="form_image_area">
                                    ...
                                    <div class="form-group {{ $errors->has('thumbnail') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" placeholder="π.χ. image.jpg" class="form-control" id="thumbnail" name="thumbnail" value="{{ old('thumbnail') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <img hidden id="image_preview" class="avatar"  alt="Δε βρέθηκε"
                                                 src="/images/thumbnails/{{old('thumbnail')}}"
                                            />
                                        </div>
                                    </div>
                                ...
                                <div class="form-group {{ $errors->has('attachement') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-10">
                                        <select id="article_attachement" name="attachement" >
                                            ...
                                            <option value="0" @if (old('attachement') == '0') selected="selected" @endif >ΟΧΙ</option>
                                            <option value="1" @if (old('attachement') == '1') selected="selected" @endif>ΝΑΙ</option>
                                        </select>
                                ...
                                <div id="article_content" class="form-group {{ $errors->has('content') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-10">
                                         <textarea cols="80" rows="10" class="form-control ckeditor" id="content_editor" name="ckeditor_content" >{{ old('ckeditor_content') }}</textarea>
