...
return [
    ...
    */
    ...
    'disks' => [
        ...
        'local' => [
            'driver' => 'local',
            'root' => public_path('images'), //default store files path  --- storage_path('app')
        ],
        ...
        'pages' => [ //for images withing page
            'driver' => 'local',
            'root'   => public_path() . '/images/pages',
        ],
        'articles' => [ //for images withing articles
            'driver' => 'local',
